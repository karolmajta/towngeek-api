...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Vote', fields ['issued_by', 'answer']
        db.create_unique(u'ratings_vote', ['issued_by_id', 'answer_id'])

        # Adding unique constraint on 'Bookmark', fields ['issued_by', 'question']
        db.create_unique(u'ratings_bookmark', ['issued_by_id', 'question_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Bookmark', fields ['issued_by', 'question']
        db.delete_unique(u'ratings_bookmark', ['issued_by_id', 'question_id'])

        # Removing unique constraint on 'Vote', fields ['issued_by', 'answer']
        db.delete_unique(u'ratings_vote', ['issued_by_id', 'answer_id'])

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'qa_answer', 'score',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Question.bookmark_count'
        db.add_column(u'qa_question', 'bookmark_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'qa_answer', 'score')

        # Deleting field 'Question.bookmark_count'
        db.delete_column(u'qa_question', 'bookmark_count')
